...
BLYNK_WRITE(V0) // Executes when the value of virtual pin 0 changes
{
  if(param.asInt() == 1)
  {
    ...
    digitalWrite(ledBuildin,LOW);  // Set digital pin 16 HIGH Build in LED
  ...
  else
  {
    ...
    digitalWrite(ledBuildin,HIGH);  // Set digital pin 16 LOW     Build in LED
