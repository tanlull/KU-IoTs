...
void loop () {
    ...
    if(indexev >= 10){
        ...
        if(water_level <0) {
          water_level =0;
//          digitalWrite(14, LOW); // to D5 (14)
//          digitalWrite(12, HIGH); // to D6 (12)
//          delay(1000);                // Wait for a second
//          digitalWrite(14, HIGH); // to D5 (14)
//          digitalWrite(12, LOW); // to D6 (12)
//          delay(1000);                // Wait for a second
        }
//        digitalWrite(14, 0); // to D5 (14)
//        digitalWrite(12, 0); // to D6 (12)
        Serial.print(dist);
        Serial.print("cm , avg =");
